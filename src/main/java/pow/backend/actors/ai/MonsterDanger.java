...
public class MonsterDanger {
    ...
    public static Danger getDanger(Actor defender, Actor attacker) {
        double likelyDamage = getMaxLikelyDamageOverall(attacker, defender);
    ...
    private static double getMaxLikelyDamageOverall(Actor attacker, Actor defender) {
        ...
        double maxDamage = likelyMaxDamage(physicalHitProb, physicalAttack, defender, SpellParams.Element.NONE);
        ...
        for (SpellParams spellParams : attacker.spells) {
            ...
            double likelySpellDamage = likelyMaxDamage(1.0, spellAttack, defender, spellParams.element);
    ...
    private static double likelyMaxDamage(double hitProb, AttackData attack, Actor defender, SpellParams.Element element) {
